  ...
  return (
    <View style={estilos.container}>
      <View style={estilos.logo}>
        <Text style={estilos.paisouregiao}>{pagina.paisouregiao}</Text>
        <Text style={estilos.texto}>{pagina.horariodechegada}    {pagina.horariodechegada}</Text>
        <Text>{pagina.observacoes}</Text>
      </View>
      <View>
